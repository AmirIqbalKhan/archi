...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-16 sm:py-24 overflow-hidden">
      {/* Enhanced Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-indigo-50/40 to-purple-50/40"></div>
      ...
      <div className="absolute top-20 left-20 w-32 h-32 bg-gradient-to-br from-[var(--modern-accent)]/20 to-purple-500/20 rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
      <div className="absolute bottom-20 right-20 w-48 h-48 bg-gradient-to-br from-blue-500/20 to-[var(--modern-accent)]/20 rounded-full mix-blend-multiply filter blur-xl animate-pulse" style={{animationDelay: '3s'}}></div>
