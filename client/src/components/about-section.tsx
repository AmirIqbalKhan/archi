      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-white rounded-xl shadow-lg p-6 border border-[var(--modern-border)]">
            ...
            <div className="absolute -top-6 -left-6 bg-[var(--modern-accent)] text-white rounded-xl p-6">
              <div className="text-center">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-xl p-6 border border-[var(--modern-border)]">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="bg-[var(--modern-accent)] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[var(--modern-gradient-2)] transition-all duration-300"
              >
                View My Work
              </button>
              <button 
